  ...
  return (
    ...
    >
      {!!id && (
        <div
          role="button"
          className="p-1 h-full rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 mr-1"
      ...
      {!!id && (
        <div className="ml-auto flex items-center gap-x-2">
          <div
            role="button"
            onClick={onCreate}
            className="p-1 opacity-0 group-hover:opacity-100 h-full ml-auto rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600"
          >
